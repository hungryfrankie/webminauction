...
$query[] = "INSERT INTO " . $DBPrefix . "fees (value, type) VALUES (0, 'offer_fee');";
...
$query[] = "INSERT INTO `" . $DBPrefix . "settings` VALUES ('offer_available', 'bool', 'y', UNIX_TIMESTAMP(), 1);";
$query[] = "INSERT INTO `" . $DBPrefix . "settings` VALUES ('offer_available_for', 'int', '0', UNIX_TIMESTAMP(), 1);";
# ############################
