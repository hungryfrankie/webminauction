...
function setvars()
{
    global $with_reserve, $reserve_price, $minimum_bid, $pict_url, $imgtype, $title, $subtitle, $sdescription, $atype, $iquantity, $buy_now, $buy_now_price, $is_taxed, $tax_included, $additional_shipping_cost,$with_offer;
    global $duration, $relist, $increments, $customincrement, $shipping, $shipping_terms, $payment, $international, $sellcat1, $sellcat2, $buy_now_only, $a_starts, $shipping_cost, $is_bold, $is_highlighted, $is_featured, $item_condition, $item_manufacturer, $item_model, $item_colour, $item_year, $item_width, $item_height, $item_lenght, $item_weight, $with_offer, $make_offer_reject, $make_offer_accept,$start_now;
    ...
    // bof make offer
    $with_offer = (isset($_POST['with_offers'])) ? $_POST['with_offers'] : $_SESSION['SELL_with_offer'];
    $make_offer= (isset($_POST['make_offer'])) ? $_POST['make_offer'] : $_SESSION['SELL_make_offer'];
    ...
    if($with_offer =='' ) $with_offer = $make_offer;
    //eof make offer
    //$with_offer = 'yes';
...
{
    global $with_reserve, $reserve_price, $minimum_bid, $pict_url, $imgtype, $title, $subtitle, $sdescription, $pict_url, $atype, $iquantity, $buy_now, $buy_now_price, $is_taxed, $tax_included, $additional_shipping_cost,$with_offer;
    global $duration, $relist, $increments, $customincrement, $shipping, $shipping_terms, $payment, $international, $sendemail, $buy_now_only, $a_starts, $shipping_cost, $is_bold, $is_highlighted, $is_featured, $item_condition,$item_manufacturer ,$item_model,$item_colour ,$item_year,$item_width,$item_height,$item_lenght,$item_weight,$with_offer,$make_offer_reject,$make_offer_accept, $start_now, $_SESSION;
    ...
    // bof make offer
    $_SESSION['SELL_with_offer'] = $with_offer;
...
{
    global $_SESSION, $DBPrefix, $dt, $a_starts, $a_ends, $payment_text, $system, $fee, $db, $caneditstartdate,$make_offer;
...
function addauction()
{
    global $DBPrefix, $_SESSION, $user, $a_starts, $a_ends, $payment_text, $system, $fee, $db, $dt,$make_offer;

    $query = "INSERT INTO " . $DBPrefix . "auctions 
...
{
    global $DBPrefix, $fee_data, $user, $system, $fee, $_SESSION, $db,$make_offer;
    ...
    //  bof for make offer  above added makeoffer fee
    ...
    $query = "INSERT INTO " . $DBPrefix . "useraccounts (auc_id,user_id,setup,featured,bold,highlighted,subtitle,relist,reserve,buynow,picture,offer_fee,extracat,total,paid) VALUES
...
{
    global $system, $DBPrefix, $buy_now_price, $reserve_price, $is_bold, $is_highlighted, $is_featured, $_SESSION, $subtitle, $sellcat2, $relist, $db,$offer_fee,$with_offer;
