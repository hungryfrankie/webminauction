...
$make_offer_accept=$db->fetch();
               if (($offer_price >=$make_offer_accept)&&($offer_item_owner!=$user->user_data['id'])){
                    $offer_message = $MSG['9802'];
            ...
            $template->assign_vars(array(
                ...
                'B_OFFER_PRICE'=>$system->print_money($offer_price, false),
